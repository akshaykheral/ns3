...
NS_LOG_COMPONENT_DEFINE("7_node_prog_0_6_5");
...
int main (int argc, char *argv[])
{
	...
	devices = p2p6.Install (nodes.Get(6), nodes.Get(5));
	address.SetBase ("10.1.2.0", "255.255.255.0");
	interface = address.Assign (devices);
    ...
    devices = p2p13.Install (nodes.Get(2), nodes.Get(6));
	//address.SetBase ("10.1.1.0", "255.255.255.0");
	//interface = address.Assign (devices);
	...
	AnimationInterface anim ("7_node_prog_0_6_5.xml");
...
Ipv4FlowClassifier::FiveTuple t = classifier->FindFlow (i->first);
      if ((t.sourceAddress=="10.1.1.1" && t.destinationAddress == "10.1.2.2") || (t.sourceAddress=="10.1.2.2" && t.destinationAddress == "10.1.1.1"))
      {
 ...
 //std::cout << "  Rx Bytes:   " << interfaces->second.rxBytes << "\n"; 
  ...
  monitor->SerializeToXmlFile("7_node_prog_0_6_5.flowmon", true, true);
