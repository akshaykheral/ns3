...
NS_LOG_COMPONENT_DEFINE("7_node_prog");
...
int main (int argc, char *argv[])
{
	...
	AnimationInterface anim ("7_node_prog.xml");
...
Ipv4FlowClassifier::FiveTuple t = classifier->FindFlow (i->first);
      if ((t.sourceAddress=="10.1.1.1" && t.destinationAddress == "10.1.5.2"))
      {
 ...
 //std::cout << "  Rx Bytes:   " << interfaces->second.rxBytes << "\n"; 
  ...
  monitor->SerializeToXmlFile("7_node_prog.flowmon", true, true);
