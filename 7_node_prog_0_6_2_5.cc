...
NS_LOG_COMPONENT_DEFINE("7_node_prog_0_6_2_5");
...
int main (int argc, char *argv[])
{
	...
	AnimationInterface anim ("7_node_prog_0_6_2_5.xml");
...
Ipv4FlowClassifier::FiveTuple t = classifier->FindFlow (i->first);
 ...
 //std::cout << "  Rx Bytes:   " << interfaces->second.rxBytes << "\n"; 
  ...
  monitor->SerializeToXmlFile("7_node_prog_0_6_2_5.flowmon", true, true);
